...
- **`OP_GLOB_SERV_STAT_RES` (0x97)** : Réponse au ping de statut global.
    - Contenu : `[Challenge 4][UserCount 4][FileCount 4][MaxUsers 4][SoftFiles 4][HardFiles 4][UDPFlags 4][LowIDUsers 4][UDPPort 2][TCPPort 2][ServerKey 4]`
    - Note : Le `Challenge` doit correspondre à celui envoyé par le client dans la requête.
