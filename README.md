...
The JAR file will be generated in `build/libs/JEmuleServer-0.5.jar`.
...
```bash
java -Djava.net.preferIPv4Stack=true -jar build/libs/JEmuleServer-0.5.jar [config_file] [port]
```
