...
- `-Djava.net.preferIPv4Stack=true`: Recommended to avoid connectivity issues with some eMule/aMule clients (forces the use of IPv4).
- `[port]`: Optional, defaults to 4661.

## License

This project is distributed under the **GNU Lesser General Public License v3.0 (LGPLv3)**. See the `LICENSE.LGPL` and `LICENSE.GPL` files for more details.
